class Endpoint {
  static const String url = "https://relieved-frog-gloves.cyclic.app/api/v1/";
  ...
  static const String deadlinePost = "${url}app/deadlines";
  ...
  static const String limits = "${url}app/limits";
  static const String limitsDelete = "${url}app/limits/";
}
